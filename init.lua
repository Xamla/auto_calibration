local auto_calibration = require 'auto_calibration.env'
...
auto_calibration.BASE_POSE_NAMES = BASE_POSE_NAMES
...
ConfigurationCalibration = require 'auto_calibration.ConfigurationCalibration'

calib = require 'auto_calibration.handEyeCalibration'
